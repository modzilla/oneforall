...
/**
 * @author Kenny Kropp
 *	This is a general Purpose Text modification File
 */
public class Text {
	 ...
	 * @param text String you want to convert
	...
	/**
	 * Please use the {@link Text#toBytes(String, Charset)} Method with the {@link Text#ASCII} Charset
	 * @param text
	 * @return
	 */
	@Deprecated
	...
	/**
	 * Please use the {@link Text#fromBytes(byte[], Charset)} Method with the {@link Text#ASCII} Charset
	 * @param text
	 * @return
	 */
	@Deprecated
	 ...
	 * @param text Your text containing non-ASCII characters
	 ...
	 * @param text Your String under Test
	...
	/**
	 * Abbreviates a String to the given Length and appending a {@link Text#ELLIPSIS_UTF8}
	 * @param text Your long input String
	 * @param length Your desired Length
	 * @return Substring of your String from 0 to length and an appended Ellipsis
	 */
	 ...
	 * @param text Your input String
	 * @param length The maximum total length
	 * @param fillChar Your fill-Char
	 ...
	 * @param text Your input "text"
	 * @param input The charset in which the text is encoded
	 * @param output The charset you wish the output to be in
	 * @return A Byte-Array with the Output encoding containing the letters in the input
	 * @throws UnsupportedEncodingException
	 */
